...
const menuData = {
  aboutUs: [
    ...
    { label: "our partners", href: "/our-pattner" },
    { label: "industry expert", href: "/industry-expert" },
  ],
  programs: [
    {
      category: "Media",
      ...
      subCategories: [
        ...
        },
        {
          ...
          courses: [
            ...
            { label: "AI & Data Science", href: "/course-page" },
  ...
  resources: [
    ...
    { label: "Careers", key: "careers", href: "/career-page" },
...
export default function NavBar() {
  ...
  const navItems = [
    ...
    { label: "Placements", key: "placements", href: "/placement-updates" },
