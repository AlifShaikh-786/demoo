      ...
      <div className="container mx-auto px-6 sm:px-10 md:px-16 lg:px-24 h-full relative z-30 flex flex-col items-start pt-36 sm:pt-40 sm:mt-14 lg:pt-32 pb-32">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* SCHOOL TAG */}
            <p className="text-white uppercase tracking-[0.2em] font-semibold mb-10 sm:mb-10 flex items-center gap-2 text-[10px] sm:text-xs md:text-2xl">
              {/* <span className="w-12 h-[1.5px] bg-blue-600/60 inline-block"></span> */}
              {slides[activeSlide].tag}
            </p>

            {/* HEADING */}
            <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-white leading-[1.2] sm:leading-[1.1] tracking-tight text-pretty">
