...
export default function CampusesSection() {
  return (
    <section className="py-20 md:py-28 bg-slate-50 overflow-hidden font-sans">
          ...
          {campusData.map((campus, index) => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-1.5 text-slate-500 text-xs font-medium uppercase tracking-wider mb-4">
                  <FaMapMarkerAlt size={10} className="text-blue-600" />
                  <span>{campus.location}</span>
                </div>

                <p className="text-slate-500 text-[14px] font-medium leading-relaxed mb-6 opacity-85 group-hover:opacity-100 transition-opacity">
                  {campus.description}
                </p>

                <div className="mt-auto">
                  <button className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-blue-700 transition-all active:scale-95 cursor-pointer shadow-md shadow-blue-200/50">
